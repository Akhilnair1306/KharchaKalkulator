...
import { ArrowLeft, PenBox, Trash2Icon } from 'lucide-react'
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
function ExpensesScreen({ params }) {
    ...
    const deleteBudget = async() =>{
        const delexpres = await db.delete(Expenses)
    ...
    return (
        <div className='p-10'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 mt-7 p-6 gap-5'>
